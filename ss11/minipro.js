const students = [
  { id: 1, name: "Nguyễn Tuấn Hưng", age: 20, gpa: 8.5, status: "active" },
  { id: 2, name: "Lê Văn Gia Huy", age: 21, gpa: 7.2, status: "active" },
  { id: 3, name: "Hoàng Minh Chiến", age: 19, gpa: 9.8, status: "active" },
  { id: 4, name: "Nguyễn Trường Vũ", age: 22, gpa: 6.5, status: "active" },
  { id: 5, name: "Vũ Anh Văn", age: 18, gpa: 10.0, status: "active" },
];
