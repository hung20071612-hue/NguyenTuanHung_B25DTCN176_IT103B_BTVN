...
let total1 = getFilteredTotalGoals(5, players);
console.log(`Tổng các bàn thắng của các cầu thủ đạt đủ chỉ tiêu là : ${total1}`);

let total2 = getFilteredTotalGoals(50, players);
console.log(`Tổng các bàn thắng của các cầu thủ đạt đủ chỉ tiêu là : ${total2}`);